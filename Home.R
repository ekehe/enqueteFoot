...
enquete <- factor(prepare$HomeTeam) #I sort the data by the awayteam
enquete
...
# 1:11, in my dataset i have 11 Home games per team
...
test <- barplot(mat,beside=TRUE,legend.text = TRUE,col=c("blue","red","green","yellow"),ylim=c(0,11),main="Home results"
